angular.module('CodeTiles', ['ngMaterial'])
    .controller('CodeController', function (GithubService) {
        ...
        // logs out variables for troubleshooting
        vm.logger = function () {
            // console.log('logging vm.repos -> ', vm.repos);
            // console.log('logging vm.gridTiles -> ', vm.gridTiles);
            console.log('logging vm.combinedTiles -> ', vm.combinedTiles);
        }; //end logger()

        // uses dot constructor syntax to add gridTiles properties to repos array within controller
        ...
        // returns random color from COLORS array using Math.random()
        ...
        // vm.tileCombiner(vm.repos, vm.gridTiles);
    });